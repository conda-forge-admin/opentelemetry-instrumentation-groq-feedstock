About opentelemetry-instrumentation-groq-feedstock
==================================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/opentelemetry-instrumentation-groq-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/opentelemetry-instrumentation-groq-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add opentelemetry-instrumentation-groq
# for installing globally
pixi global install opentelemetry-instrumentation-groq
```
...
It is possible to list all of the versions of `opentelemetry-instrumentation-groq` available on your platform:
...
```
pixi search opentelemetry-instrumentation-groq --channel conda-forge
```
